    ...
    def post(self, request):
        try:
            ...
            try:
                ...
                # Set column headers only for new file
                if ws['A1'].value != self.EXCEL_HEADERS[0]:
                    ws.delete_rows(1, ws.max_row)  # Clear any existing data
                    ws.append(self.EXCEL_HEADERS)

                # Format and add enrollment data
                enrollment_data = [
